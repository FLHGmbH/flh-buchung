...
export function AdminNew() {
  ...
  return (
    <div className="page">
      <h1>Neuer Mandant</h1>
      <p className="lead">Betrieb anlegen. KD-Login vorher in Supabase Auth mit derselben E-Mail anlegen.</p>
      ...
      <form className="panel" style={{ maxWidth: 480 }} onSubmit={submit}>
        ...
        <label className="field"><span>KD-E-Mail (Supabase Auth)</span><input type="email" value={form.adminEmail} onChange={(e) => setForm({ ...form, adminEmail: e.target.value })} required /></label>
...
export function AdminDetail() {
  ...
  return (
    <div className="page">
      ...
      <p className="lead">Passwort nur in Supabase Auth (Authentication → Users).</p>
      <p>
